 ...
 */
public class Problem054_PokerHands {  // TODO: Problem054_PokerHands
    public static void main(String[] args) {
        ...
        for(int i=0; i < map.length; i++) {
            String[] player1Cards = new String[] { map[i][0], map[i][1], map[i][2], map[i][3], map[i][4] };
            String[] player2Cards = new String[] { map[i][5], map[i][6], map[i][7], map[i][8], map[i][9] };
